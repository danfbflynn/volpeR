...
```{r}
setwd("M:/R") # This will be different for you, and different again on your work computer
...
2. Go to the course website: http://bit.ly/volpeR 
  ...
  + Use the file naming convention `Homework 1 <Lastname>.R` and `Homework 1 <Lastname>.csv` for your script and your data file, respectively
