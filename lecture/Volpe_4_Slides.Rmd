---
title: 'Volpe R Course: Session 7, Communicating Results'
...
<!-- ![You should get this!](M:/R/snip4.png) --> 

```{r, out.width = "200px", echo = F}
knitr::include_graphics("M:/R/snip4.png")
```
...
knitr::include_graphics("M:/R/Header.jpg")
```

### Markdown text

```{r, out.height = "200px", echo = F}
knitr::include_graphics("M:/R/Text.jpg")
```

### R code

```{r, out.width = "50px", echo = F}
knitr::include_graphics("M:/R/Rcode.jpg")
```
...
knitr::include_graphics("M:/R/TableKable.jpg")
